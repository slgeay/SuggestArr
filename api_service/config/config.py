...
def get_default_values():
    ...
    return {
        ...
        'SECONDARY_SEER_API_URL': lambda: '',
        'SECONDARY_SEER_TOKEN': lambda: '',
        'SECONDARY_SEER_USER_NAME': lambda: None,
        'SECONDARY_SEER_USER_PSW': lambda: None,
        'SECONDARY_SEER_SESSION_TOKEN': lambda: None,
        'SEER_PRIMARY_LABEL': lambda: 'Primary',
        'SECONDARY_SEER_LABEL': lambda: 'Secondary',
...
def get_config_sections():
    ...
    return {
        'services': ['TMDB_API_KEY', 'OMDB_API_KEY', 'SELECTED_SERVICE', 'PLEX_TOKEN', 'PLEX_API_URL', 'PLEX_CLIENT_ID',
                    ...
                    'SECONDARY_SEER_SESSION_TOKEN', 'SECONDARY_SEER_LABEL',
